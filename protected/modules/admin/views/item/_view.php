<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('media_descr')); ?>:</b>
	<?php echo CHtml::encode($data->media_descr); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('media_data')); ?>:</b>
	<?php echo CHtml::encode($data->media_data); ?>
	<br />
